...
public:
  ...
  std::vector<std::vector<double> > lower_bound_vals() {
    ...
    lb1.push_back(-689.38923); //y for valid values 1
    lb1.push_back(516.721733); //y for valid values 2
    lb1.push_back(0.0); //y for valid values 3
    lb2.push_back(-692.77556); //alpha for valid values 1
    lb2.push_back(-692.96866); //alpha for valid values 2
    lb2.push_back(-691.77552); //alpha for valid values 3
    lb3.push_back(-1381.5511); //beta for valid values 1
    lb3.push_back(-174.50177); //beta for valid values 2
    lb3.push_back(-690.77556); //beta for valid values 3
