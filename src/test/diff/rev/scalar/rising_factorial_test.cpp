...
TEST(DiffRevScalar,rising_factorial_var_double) {
...
TEST(DiffRevScalar, rising_factorial_exceptions) {
  double a(1);
  AVAR b(-3.0);
...
TEST(DiffRevScalar, rising_factorial_double_var) {
  using boost::math::digamma;
  double a(5);
  AVAR b(4.0);
...
TEST(DiffRevScalar, rising_factorial_var_var) {
  using boost::math::digamma;
  AVAR c(4.0);
  AVAR b(4.0);
