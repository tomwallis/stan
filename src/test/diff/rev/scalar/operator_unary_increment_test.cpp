...
TEST(DiffRevScalar,plus_plus_a) {
  AVAR a(5.0);
...
TEST(DiffRevScalar,plus_plus_a_2) {
  AVAR a(5.0);
  EXPECT_FLOAT_EQ(5.0,a.val());
  AVAR f = ++a;
  EXPECT_FLOAT_EQ(6.0,f.val());
...
TEST(DiffRevScalar,plus_plus_a_3) {
  AVAR a(5.0);
  AVAR f = ++a;
...
TEST(DiffRevScalar,a_plus_plus) {
  AVAR a(5.0);
...
TEST(DiffRevScalar,a_plus_plus_2) {
  AVAR a(5.0);
  AVAR f = a++;
